...
## Version History
This repo reflects the latest version (v3, 2025). The bot has evolved through multiple iterations:
- **v3 (2025)** — Uniswap V3 + PancakeSwap V3 support, improved slippage handling, ignition deployment
- **v3 (Jan 2025)** — Added multi-token pair support
- **v3 (Oct 2024)** — Initial V3 implementation
